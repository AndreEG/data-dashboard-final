...
// guarda en un array los objetos de cada sede que tienen cuyo key value son sedes con sus objetos
...
function showGeneration(obj) { // nos va a mostrar la cantidad de estudiantes activas
    ...
    Students.textContent = 'ESTUDIANTES INSCRITAS: ' + cantEstudents + ' inscritas'; // agrega contenido al div donde debe ir la info de estudiantes
...
function showMetas(obj) {
    ...
    var sprintsCant = obj['ratings'].length;// se toma la cantidad total de sprint
    ...
    google.charts.load('current', {'packages':['corechart']});
    google.charts.setOnLoadCallback(drawChartSupera);
    function drawChartSupera() {
      var data = google.visualization.arrayToDataTable([
        ['estudiantes', 'cantidad'],
        ['Superaron', promGeneral],
        ['No superaron', cantEstudents - promGeneral]
      ]);
      var options = {
        title: 'ESTUDIANTES QUE SUPERARON LA META EN PROMEDIO',
        'width': 320,
        'height': 220
      };
...
function showRatings(obj) {
    ...
    var nps1 = obj['ratings'][0]['nps']['promoters'] - obj['ratings'][0]['nps']['detractors'];
    var nps2 = obj['ratings'][0]['nps']['promoters'] - obj['ratings'][1]['nps']['detractors'];
    var nps3 = obj['ratings'][0]['nps']['promoters'] - obj['ratings'][2]['nps']['detractors'];
    var nps4 = obj['ratings'][0]['nps']['promoters'] - obj['ratings'][3]['nps']['detractors'];
    ...
    function drawStuff() {
      ...
      var options = {
        title: 'NET PROMOTE SCORES',
        width: 320,
        legend: { position: 'none' },
        chart: { title: 'NET PROMOTE SCORES'},
        bars: 'horizontal', // Required for Material Bar Charts.
        axes: {
          x: {
...
function showStudentData(e) {
         ...
         var techBox = document.getElementById('box-tech'); 
         var  lifeBox = document.getElementById('box-life');
         var  photoBox = document.getElementById('box-photo');
  ...
  for (var j = 0;j < sa.length;j++) {
    ...
    photoStudent.setAttribute('src', 'assets/images/'+ nombre + '.jpg');
    divStudent.classList.add('squarep-container');
    divStudent.appendChild(photoStudent);
    photoBox.appendChild(divStudent);
